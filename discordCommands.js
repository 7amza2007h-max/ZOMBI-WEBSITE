...
const commands=[
  ...
  {name:'games',default_member_permissions:'8',description:'فتح قائمة ألعاب ZOMBI أو تشغيل لعبة',options:[{type:3,name:'game',description:'اختياري: شغّل لعبة مباشرة',required:false,choices:gamesChoices}]},
  {name:'roulette',default_member_permissions:'8',description:'تشغيل لعبة الروليت'},
