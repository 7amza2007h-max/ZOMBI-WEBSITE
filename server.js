...
async function start(){
  ...
  app.post('/dashboard/:guildId/settings',requireLogin,requireGuildAccess,checkCsrf,async(req,res,next)=>{try{
    ...
    const knownSections=new Set(['all','logs','overview','economy','members','store','games','city','heist','gangs','robbery','roles','name','tickets','voice']);
