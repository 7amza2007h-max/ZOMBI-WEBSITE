...
const DEFAULT_PLAN_RULES = {
  free: {
    features: {
      ...
      economy:true, economyAdmin:false, bank:true, games:true, tickets:true, store:true, rolePanel:true,
    ...
    limits: {
      ...
      maxBankTransaction:25000,
      maxClearMessages:25,
      maxDailyReward:2000,
      maxMessageReward:100,
      maxVoiceReward:100
    }
  },
  premium: {
    ...
    games: {
      ...allGameDefaults(false),
      quiz:true, guess:true, rps:true, speed:true, scramble:true, truefalse:true,
      math:true, closest:true, word:true, wheel:true, daily:true, mafia:true, roulette:true, chairs:true, killer:true
    },
    limits: {
      storeProducts:25,
      selfRoles:20,
      ...
      maxBankTransaction:1000000000,
      maxClearMessages:100,
      maxDailyReward:1000000000,
      maxMessageReward:1000000000,
      maxVoiceReward:1000000000
    }
  }
};
